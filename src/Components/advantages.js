...
const data = [
  ...
  createData(
    ...
    "Надад олон тооны программийн алдаа гарж байсан эдгээрийн 60% өөрөө шийдэж чаддаг. Би асуудал шийдэхдээ процессийг төсөөлөн даган утга зөв буйг шалгаж тул хялбар байдаг",
    "bug.jpg"
  ),
  createData(
