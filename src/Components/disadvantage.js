...
const data = [
  createData(
    "Би бол дотогшоо хүн",
    "Би өмнө нь хэдхэн хүнээс цааш харилцдаггүй байсан тул олон хүнтэй ярилцах дургүй мөн чаддаггүй байсан. Иймээс миний харилцах чадвар бусадтай харьцуулахад муухан",
    "introvert.jpg"
  ),
  createData(
    "Би удаан цагаар юмс уншиж чаддаггүй",
    "Удаан цагаар юмс уншихад уншсан юм толгойд орохгүй эсвэл хараа тогтож өгдөггүй тул 1-2 цаг уншаад 30 минут завсарлага авж байдаг",
    "bookRead.png"
  ),
  createData(
    "Би өндөр төвлөрөлтэй",
